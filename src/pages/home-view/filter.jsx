...
export default function FilterTransaction() {
  ...
  const handleReset = () => {
    setFilter(initialState); // Reset filters to initial state
    dispatch(getFilteredTransactions(initialState)); // Fetch all transactions
  };
    ...
    <div className="flex flex-col align-middle text-center mx-auto">
      ...
      >
        ...
        <div className="flex flex-col w-full md:w-auto">
          <label htmlFor="user_id" className="text-gray-600">
            User ID:
          </label>
          <input
            id="user_id"
        ...
        <div className="flex flex-col w-full md:w-auto">
          <label htmlFor="transaction_type" className="text-gray-600">
            Transaction Type:
          </label>
          <select
            id="transaction_type"
