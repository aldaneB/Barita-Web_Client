...
export default function TransactionTable() {
  ...
  return (
    <div>
      ...
      <div className="flex gap-2 shrink-0 sm:flex-row mb-5 align-center">
      ...
      <div className="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-xl bg-clip-border">
        <table className=" w-[600px] mx-auto align-middle sm:mx-auto text-sm  text-left text-gray-500 dark:text-gray-400">
          <thead>
            <tr>
              <th
                scope="col"
